...
<html>
  ...
  <!-- header -->
   ...
   <li><a href = "#services">services</a></li>
    ...
    {
?>
    <li><a href = "DashboardUser.php">Account</a></li>
       
    <?php} if (isset($_SESSION["role"]) && $_SESSION["role"]=="admin")
    {
?>
  <li><a href = "DashboardAdmin.php">Admin Space</a></li>
...
?>
 ...
 <button class = "btn sign-up" href="signup.php">sign up</button>
    <button class = "btn log-in" href="signin.php">log in</button>
