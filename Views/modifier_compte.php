    ...
    <div class="page-content">
        <div class="form-v5-content">
            ...
            <form class="form-detail" action="modifierUser.php" method="post">
                ...
                <div class="form-row">
                    <label for="full-name">Facture</label>
                    <input type="number" name="facture" id="facture" class="input-text" placeholder="Facture" value="<?php  echo $Old_User["Facture"]?>" required>
                    <i class="fas fa-user"></i>
                </div>
                <br>
                <div class="form-row">
